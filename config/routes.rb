Rails.application.routes.draw do
  ...
  # ====================================================================== [ Playlist Routs ]
  # playlist_index      GET    /playlist(.:format)          playlist#index           |
  #                     POST   /playlist(.:format)          playlist#create      <----
  #   new_playlist      GET    /playlist/new(.:format)      playlist#new
  #  edit_playlist      GET    /playlist/:id/edit(.:format) playlist#edit
  #       playlist      GET    /playlist/:id(.:format)      playlist#show
  #                     PATCH  /playlist/:id(.:format)      playlist#update
